...
const icons: Record<string, (props: SVGProps<SVGSVGElement>) => ReactElement> = {
  mail: (props) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M21.75 7.5v9A2.25 2.25 0 0 1 19.5 18.75h-15A2.25 2.25 0 0 1 2.25 16.5v-9m19.5 0A2.25 2.25 0 0 0 19.5 5.25h-15A2.25 2.25 0 0 0 2.25 7.5m19.5 0-8.69 5.793a1.875 1.875 0 0 1-2.12 0L2.25 7.5" />
    </svg>
  ),
  finance: (props) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" {...props}>
...
interface ModuleIconProps extends Omit<SVGProps<SVGSVGElement>, 'ref'> {
  slug: string
  className?: string
}

export function ModuleIcon({ slug, className = 'h-4 w-4', ...props }: ModuleIconProps) {
